...
<div className="navbar">
    <h5>NETFLIX</h5>
    <Link to="/login"> <button className="btn bt-danger">SIGN IN</button></Link>
    ...
    <center>
        <Form style={{ width: "50%" }} className="d-flex">
            <FormControl
                ...
                className="mr-2"
            />
            <Link to="/shows" style={{ width: "30%", backgroundColor: "red" }} className="btn btn-danger">Get started&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i></Link>
        </Form>
    </center>
</div>
